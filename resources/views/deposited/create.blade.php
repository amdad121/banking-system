...
@section('content')
    <div class="mx-auto w-7/12">
        <h3 class="mb-4 border-b pb-2 text-center text-xl font-semibold">Deposite</h3>
        <form class="flex flex-col gap-4" action="{{ route('deposited_transactions.store') }}" method="POST">
            @csrf
